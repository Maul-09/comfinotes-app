				...
				<div class="row">
					<div class="col-xl-9">
						<div class="row">
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header flex-wrap border-0 pb-0 align-items-end mb-4">
										<div class="mb-3 me-3">
											<h5 class="fs-20 text-black font-w500">Total Money</h5>
											<span class="text-num text-black fs-36 font-w500">IDR 25.000.000</span>
										</div>
										<div class="me-3 mb-3">
											<p class="fs-14 mb-1">Recent Update</p>
											<span class="text-black fs-16">08/21</span>
										</div>
										<div class="me-3 mb-3">
											<p class="fs-14 mb-1">ADVISOR</p>
								...
								<div class="card">
									<div class="card-header d-sm-flex d-block border-0 pb-0">
										<div class="me-auto mb-sm-0 mb-4">
											<h4 class="fs-20 text-black">List All Group</h4>
										</div>
										<a href="javascript:void(0);" class="btn btn-primary btn-rounded btn-md mx-3">+Add New Group</a>
									</div>
									<div class="card-body pb-0">
										<div class="d-flex mb-3 border-bottom justify-content-between flex-wrap align-items-center">
											<div class="d-flex pb-3 align-items-center">
												<img src="aset/images/card/1.jpg" alt="" class="rounded me-3 card-list-img" width="130">
												<div class="me-3">
													<p class="fs-14 mb-1">Name Group</p>
													<span class="text-black font-w500">Divisi Logistik</span>
												</div>
											</div>
											<div class="me-3 pb-3">
												<p class="fs-14 mb-1">RECENT UPDATE</p>
												<span class="text-black font-w500">9/7/2024</span>
											</div>
											<div class="me-3 pb-3">
												<p class="fs-14 mb-1">ADVISOR</p>
												<span class="text-black font-w500">Franklin Jr.</span>
											</div>
											<a href="javascript:void(0);" class="fs-14 btn-link me-3 pb-3">See Group</a>
